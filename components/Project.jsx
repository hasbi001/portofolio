...
export default function ExperienceProjectSlider({
  title,
  eyebrow,
  description,
  items,
      ...
      <section className="container-page py-24">
        ...
        <div className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          ...
          <div>
            ...
            <p
              className={`mb-3 text-sm font-semibold uppercase tracking-[.25em] ${accent.text}`}
            >
              {eyebrow}
            </p>
            ...
            {items.map((item, index) => (
              ...
              >
                ...
                <div className="mb-6 flex items-start justify-between">
                  ...
                  <div
                    className={`rounded-2xl p-3 ${accent.bg} ${accent.text}`}
                  >
                ...
                <p
                  className={`text-xs font-semibold uppercase tracking-widest ${accent.text}`}
                >
                  {item.period}
                </p>
          ...
          >
            ...
            <div className="pr-10">
              ...
              <div className="mb-6 flex items-center gap-4">
                ...
                <div
                  className={`rounded-2xl p-4 ${accent.bg} ${accent.text}`}
                >
